...
public class HomeFragmentBannerAdapter extends BannerAdapter<Integer, HomeFragmentBannerAdapter.BannerViewHolder> {

    public HomeFragmentBannerAdapter(List<Integer> mDatas) {
